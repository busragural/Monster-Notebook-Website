      ...
      <div className='content-container'>
        ...
        {showMore && (
          <>
            ...
            <p className='content'>Oyunların yanı sıra diğer tüm uygulamalarda daha fazla performans elde etmenize, 2K ve üzerindeki çözünürlüklerde oyun oynamanıza ortam hazırlayan Tulpar serisi, sizin için ideal seçenek haline geliyor.</p>
            <p className='content'>Sahip olduğu donanım sayesinde Gaming ailesinin en güçlü notebook serisi Semruk ise sizi, herkesin şahit olamayacağı bir oyun atmosferine davet ediyor.</p>
            <p className='content'>Güçlü ve işlevsel bir dizüstü bilgisayara gereksiniminiz varsa Huma serisi, 3D tasarım ve render gibi yüksek işlem gücü gerektiren uygulamalarla çalışıyorsanız Markut serisi içerisinde boy gösteren notebook modelleri, projelerinizi kısa sürede tamamlamanıza yardım ediyor.</p>
            <p className='content'>Monster, almayı planladığınız dizüstü bilgisayarı modelleri için satış öncesinde konfigürasyon özelleştirme seçenekleri sunarak bilgisayarınızı belirli ölçülerde kişiselleştirebilmenize olanak veriyor. Bu noktada ekleyeceğiniz donanıma bağlı olarak notebook fiyatları değişiklik gösteriyor.</p>
